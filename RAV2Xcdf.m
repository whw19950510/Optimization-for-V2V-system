...
sumcapacitybench=sumcapacity-1;
figure(3)
[distributionsumc,steprand1]=ksdensity(sumcapacity,'function','cdf','width',.55);
[distributionsumcbench,steprand2]=ksdensity(sumcapacitybench,'function','cdf','width',.55);
plot(steprand1,distributionsumc,'-ro','Linewidth',2)
hold on
plot(steprand2,distributionsumcbench,'-b*','Linewidth',2)
grid on
title('遍历容量和的累积分布');
xlabel('遍历容量和Cm/bps')
ylabel('CDF')
